...
class testLAB(unittest.TestCase): 
    ...
    def test_simple_query(self):
        url = "http://localhost:8080/query/simple"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_join1(self):
        url = "http://localhost:8080/query/join1"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_join2(self):
        url = "http://localhost:8080/query/join2"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_join3(self):
        url = "http://localhost:8080/query/join3"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_join4(self):
        url = "http://localhost:8080/query/join4"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_join5(self):
        url = "http://localhost:8080/query/join5"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_function2(self):
        url = "http://localhost:8080/query/function2"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_function3(self):
        url = "http://localhost:8080/query/function3"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_function4(self):
        url = "http://localhost:8080/query/function4"
        response = get(url)
        self.assertEqual(200, response.status_code)

    def test_function5(self):
        url = "http://localhost:8080/query/function5"
        response = get(url)
        self.assertEqual(200, response.status_code)